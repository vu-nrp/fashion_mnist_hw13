    ...
    if (identifier == "s") {
      ...
      do {
        ...
        if (value == "DT_INVALID") {
          ...
          msg->add_type(::tensorflow::DT_FLOAT8_E5M2);
        } else if (value == "DT_FLOAT8_E4M3FN") {
          msg->add_type(::tensorflow::DT_FLOAT8_E4M3FN);
        } else if (value == "DT_INT4") {
          msg->add_type(::tensorflow::DT_INT4);
        } else if (value == "DT_UINT4") {
          msg->add_type(::tensorflow::DT_UINT4);
          ...
          msg->add_type(::tensorflow::DT_FLOAT8_E5M2_REF);
        } else if (value == "DT_FLOAT8_E4M3FN_REF") {
          msg->add_type(::tensorflow::DT_FLOAT8_E4M3FN_REF);
        } else if (value == "DT_INT4_REF") {
          msg->add_type(::tensorflow::DT_INT4_REF);
        } else if (value == "DT_UINT4_REF") {
          msg->add_type(::tensorflow::DT_UINT4_REF);
        } else {
          int32 int_value;
  ...
  while(true) {
    ...
    if (identifier == "s") {
      ...
      if (value == "DT_INVALID") {
        ...
        msg->set_type(::tensorflow::DT_FLOAT8_E5M2);
      } else if (value == "DT_FLOAT8_E4M3FN") {
        msg->set_type(::tensorflow::DT_FLOAT8_E4M3FN);
      } else if (value == "DT_INT4") {
        msg->set_type(::tensorflow::DT_INT4);
      } else if (value == "DT_UINT4") {
        msg->set_type(::tensorflow::DT_UINT4);
      } else if (value == "DT_FLOAT_REF") {
        ...
        msg->set_type(::tensorflow::DT_FLOAT8_E5M2_REF);
      } else if (value == "DT_FLOAT8_E4M3FN_REF") {
        msg->set_type(::tensorflow::DT_FLOAT8_E4M3FN_REF);
      } else if (value == "DT_INT4_REF") {
        msg->set_type(::tensorflow::DT_INT4_REF);
      } else if (value == "DT_UINT4_REF") {
        msg->set_type(::tensorflow::DT_UINT4_REF);
      } else {
        int32 int_value;
        if (strings::SafeStringToNumeric(value, &int_value)) {
