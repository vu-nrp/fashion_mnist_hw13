...
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kHostThreadsPlaneName;
// Name prefix of XPlane that contains GPU events.
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kGpuPlanePrefix;
// Name prefix of XPlane that contains TPU events.
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kTpuPlanePrefix;
// Regex for XPlanes that contain TensorCore planes.
TF_CONST_INIT TSL_EXPORT extern const char kTpuPlaneRegex[];
// Name prefix of XPlane that contains custom device events.
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kCustomPlanePrefix;
// Name prefix of XPlane that contains TPU non-core events such as HBM, ICI etc.
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kTpuNonCorePlaneNamePrefix;
// Name prefix of XPlane that contains TPU runtime events.
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kTpuRuntimePlaneName;
// Name of XPlane that contains CUPTI driver API generated events.
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kCuptiDriverApiPlaneName;
// Name of XPlane that contains Roctracer API generated events.
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kRoctracerApiPlaneName;
// Name of XPlane that contains profile metadata such as XLA debug info.
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kMetadataPlaneName;
// Name of XPlane that contains kpi related metrics.
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kTFStreamzPlaneName;
// Name of XPlane that contains events from python tracer.
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kPythonTracerPlaneName;
// Name of XPlane that contains kTrace thread-switch events
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kHostCpusPlaneName;
// Name of XPlane that contains kTrace system calls.
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kSyscallsPlaneName;

// Names of XLines that contain ML-level events.
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kStepLineName;
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kTensorFlowNameScopeLineName;
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kTensorFlowOpLineName;
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kXlaModuleLineName;
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kXlaOpLineName;
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kXlaAsyncOpLineName;
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kKernelLaunchLineName;
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kSourceLineName;
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kCounterEventsLineName;

// GPU device vendors.
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kDeviceVendorNvidia;
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kDeviceVendorAMD;

// Name of Xplane that contains environment information
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kTaskEnvPlaneName;
