...
// Special op types.
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kUnknownOp;
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kDatasetOp;
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kMemcpyHToDOp;
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kMemcpyDToHOp;
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kMemcpyDToDOp;
TF_CONST_INIT TSL_EXPORT extern const absl::string_view kMemcpyHToHOp;
...
#endif  // TENSORFLOW_TSL_PROFILER_UTILS_TF_OP_UTILS_H_
